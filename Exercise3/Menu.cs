...
namespace Exercise3
{
    class Menu
    {
        ...
        {
            // Суть задания в том была, что пользователь может ввести производное число для создания новой матрицы.
            // Для усложнения можно было значения первоночальные выделить другим цветом, а новые (если матрица
            // расширилась). Т.е. матрица может расширятся как в меньшую сторону, так и в большую.
